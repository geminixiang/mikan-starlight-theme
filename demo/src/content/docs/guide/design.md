...
This page mirrors the theme's design contract so users can see the visual rules behind the package.

## Source

This design brief is based on [getdesign.md's x.ai analysis](https://getdesign.md/x.ai/design-md).
